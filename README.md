# crud-nodejs-json-2021
El siguiente constituye un desarrollo estrictamente académico sobre un Create - Read - Update - Delete (CRUD)  ó un Altas - Bajas - Modificaciones (ABM). Desarrollado Bajo NodeJS. (Al descargar debes ejecutar el comando: npm install)
<hr>
